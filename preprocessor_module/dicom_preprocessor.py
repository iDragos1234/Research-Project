...
class DicomPreprocessor:
    ...
    Attributes
    ----------
    data_dr_path (str): Path to the input data - path to the directory where 
    ...
    target_pixel_array_shape (tuple[int, int], optional): Desired image and mask shape
        after applying the `monai.transforms.ResizeWithPadOrCrop` transforms.
    ...
    def preprocess(self) -> None:
        ...
        dicom_files_metadata = list_dicom_files.ListDicomFiles(self.data_dir_path)()
